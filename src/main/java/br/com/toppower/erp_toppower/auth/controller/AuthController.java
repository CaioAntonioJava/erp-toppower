...
public class AuthController {
    ...
    @Operation(
            ...
            description = "Autentica o usuário pelo e-mail e senha, retornando um token JWT " +
                    "no formato Bearer. Use esse token no header Authorization das requisições protegidas."
    )
