 ...
 * a receber. Quando a conta tem uma única parcela (à vista), o usuário
 * pode omitir a lista de parcelas e informar apenas o vencimento-base
 * — o service cria a parcela 1 automaticamente.
 */
@Schema(name = "ReceivableInstallmentRequest",
        description = "Dados de uma parcela programada de conta a receber.")
