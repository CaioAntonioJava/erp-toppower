...
@Schema(name = "ProfileCreateRequest", description = "Dados para cadastro do próprio perfil. " +
        "O vínculo com o usuário é feito automaticamente a partir do JWT (1:1).")
public record ProfileCreateRequest(
        ...
        @Schema(description = "E-mail de contato do perfil (deve ser único entre perfis).",
