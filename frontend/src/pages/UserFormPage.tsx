 ...
 * Rota: /users/new.
 *
 * O usuário criado é vinculado automaticamente ao tenant da sessão do
 * admin e cadastrado com o papel ROLE_MANAGER pelo backend.
 */
    ...
    <div className="space-y-6">
      ...
      <Alert variant="info">
        <div className="inline-flex items-start gap-2">
          ...
          <span>
            O usuário será vinculado à empresa (tenant) atual da sua sessão e
            cadastrado como <strong>Gestor</strong>. O e-mail deve ser único no sistema.
          </span>
        </div>
      </Alert>
